...
namespace App\Models {
     ...
     * @property int(10) unsigned $spin_amount
     * @property decimal(10,2) $balance
     * @property int(10) unsigned $status
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|User whereSpinAmount($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|User whereMobNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder|User whereIdentityImage($value)
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereWebTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereTagline($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereLogo($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereIcon($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereFooterLogo($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereFavIcon($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig wherePrimaryEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSecondaryEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSupportEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig wherePrimaryPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSecondaryPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereAboutUs($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig wherePrivacyPolicy($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereTermsConditions($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereFacebookLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereTwitterLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereInstagramLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereLinkedinLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereYoutubeLink($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSmtpHost($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSmtpPort($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSmtpUsername($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSmtpPassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereSmtpEncryption($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereColorPrimary($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereColorSecondary($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereBackgroundColor($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereFontFamily($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereMetaKeywords($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereMetaDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereTimezone($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereCurrency($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereMaintenanceMode($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|WebConfig whereUpdatedAt($value)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class WebConfig extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
