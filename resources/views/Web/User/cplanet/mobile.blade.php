...
<div class="content-body">
    <div class="mobile-recharge-container ">
        ...
        <form id="rechargeForm" action="{{ route('user.c_recharge') }}" method="POST">
            @csrf 
            <div class="input-section">
                ...
                <div class="input-group_1 mb-2">
                    <div class="input-with-icon">
                        <input type="text" id="amount" name="amount" placeholder="Enter Recharge Amount" value="{{ old('amount') }}" >
                ...
                <div class="plans-button-container mt-4">
                    <button type="submit" class="check-plans-btn mt-3 text-decoration-none">Recharge</button>
                </div>
            </div>
        </form>
