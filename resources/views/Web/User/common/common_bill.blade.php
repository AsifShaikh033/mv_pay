...
<div class="mobile-recharge-container ">
        ...
        <button class="prepaid-button mb-3">{{ $serviceType }}</button>
    ...
    <div class="input-section">
        <div class="input-group_1 mb-2">
            ...
            <div class="input-with-icon">
                <input type="text" id="bill-number" name="bill_number" placeholder="{{ $serviceType }}" value="{{ old('bill_number') }}" required>
    ...
    <p>Recent or Personal {{ $serviceType }} Recharges</p>
    <div class="recharge-history mt-3">
        <h6 class="fw-bold">Recent {{ $serviceType }} Numbers</h6>
