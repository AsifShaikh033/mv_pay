...
<div class="mobile-recharge-container ">
    ...
    <form id="rechargeForm" action="{{ route('user.dth.bill_fetch') }}" method="GET">
    ...
    <div class="input-group_1 mb-2">   
            ...
            <div class="input-with-icon">
                <input type="text" id="bill-number" name="dth_number" placeholder="Enter Mobile number" value="{{ old('dth_number') }}" required>
