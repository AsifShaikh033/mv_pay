...
<div class="content-body mt-5">
    <div class="container_index container">
        ...
        <div class="row align-items-center mt-2 text-center">
            ...
            <div class="col-6">
                <h4 class="change_name font-bolder">Payment of ₹ {{$transaction->amount}} is Pending!</h4>
            ...
            <div class="col-6">
                ...
                <div class="website-link mt-1">
                    ...
                    <div class="change_name fs-12">
                        <label for="" class="m-0 p-0">Our Website:</label><br> <a href="https://www.mveasypay.com" target="_blank">www.mveasypay.com</a>
                    </div>
                </div>
            </div>
            <div class="col-6">
